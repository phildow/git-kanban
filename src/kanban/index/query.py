...
class SearchQuery:
    ...
    # Columns to leave out, by slug.  The archive is not among them: the index
    # holds every task and the service is what leaves the archived ones out,
    # knowing which column holds each board's archive.

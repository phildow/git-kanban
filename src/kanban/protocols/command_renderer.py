...
class CommandRenderer(ABC):
    ...
    @abstractmethod
    def render_task_tag(self, args: argparse.Namespace, result) -> None:
        ...
    ...
    @abstractmethod
    def render_set_config(self, args: argparse.Namespace, result) -> None:
        ...

    @abstractmethod
    def render_get_config(self, args: argparse.Namespace, result) -> None:
        ...

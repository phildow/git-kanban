...
NORMAL_BINDINGS: list[tuple[str, str]] = [
    ...
    ("alt + any of those", "jump to the end of the column or board"),
    ...
    ("tab tab in the command bar", "fill an empty task in with the selected card"),
...
HEADER_BINDINGS: list[tuple[str, str]] = [
    ...
    ("alt + ←/→", "move this column along the board"),
...
DETAIL_BINDINGS: list[tuple[str, str]] = [
    ...
    ("alt + any of those", "scroll the description and comments"),
...
MOVE_BINDINGS: list[tuple[str, str]] = [
    ...
    ("alt + any of those", "stage it as far as it will go that way"),
